...
import * as photoManager from './src/utils/enums/photoManager.js';
...
app.whenReady().then(() => {
	...
	ipcMain.handle('photos:saveEditedImage', async (event, photoPath, base64Data) => photoManager.saveEditedImage(photoPath, base64Data));
});
